  ...
  return (
    <div>
        ...
        {results.length > 0 && (
          <div className="col-12 lg:col-6 xl:col-3">
            <div className="card mb-0">
              <div className="flex justify-content-between mb-3">
                <div>
                  <span className="block text-500 font-medium mb-3">Total Inconsistências entre CPF</span>
      ...
      {showSuccessMessageErro && (
        <Message severity="success" text="Parabéns!! Não houve nenhum funcionário que caiu na vala. Não houve nenhum erro." />
      )}

      {showWarningMessageErro && (
        <Message severity="warn" text={`Houveram ${erros.length} funcionários que cairam na vala.`} />
      )}
      ...
      {showSuccessMessage && (
        <Message severity="success" text="Não houve nenhuma inconsistência." />
      )}

      {showWarningMessage && (
        <Message severity="warn" text={`Houveram ${results.length} inconsistências.`} />
      )}
